...
export const API_PATHS = {
    ...
    // 配置迁移相关API
    SUBSCRIPTIONS: '/open/subscriptions', // 订阅配置
    CONFIG_FILES: '/api/config',          // 配置文件
    CONFIGS_SAVE: '/open/configs/save',
    DEPENDENCIES: '/open/dependencies',   // 项目依赖
    SYSTEM_SETTINGS: '/api/settings',     // 系统设置
};
...
export const MESSAGE_TYPES = {
    ...
    // 配置迁移相关消息类型
    EXPORT_CONFIG: 'exportConfig',       // 导出配置
    IMPORT_CONFIG: 'importConfig',       // 导入配置
};
